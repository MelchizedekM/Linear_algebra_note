...
\defe
在这个定义中，我们默认了数乘，也就是 $ \forall a \in \R \b \forall \v \in \V \b a\v \in \V $，的存在性。这也是我们讨论线性代数的基础之一。
...
在上一个小节，我们介绍了什么是vector space。而在这一章节中，我们将会从一个重要的概念——linear出发，探讨我们该如何构建一个vector space以及vector的一些重要形式。
